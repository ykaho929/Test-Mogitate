...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => "/storage/fruits-img_kiwi.png",
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => "/storage/fruits-img_strawberry.png",
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => "/storage/fruits-img_orange.png",
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => "/storage/fruits-img_watermelon.png",
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => "/storage/fruits-img_peach.png",
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => "/storage/fruits-img_muscat.png",
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => "/storage/fruits-img_pineapple.png",
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => 800,
            'image' => "/storage/fruits-img_grapes.png",
        ...
        $param = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => "/storage/fruits-img_banana.png",
        ...
        $param = [
            'name' => 'メロン',
            'price' => 900,
            'image' => "/storage/fruits-img_melon.png",
